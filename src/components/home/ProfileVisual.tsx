  ...
  return (
    <div className="relative">
      ...
      <Surface className="space-border relative overflow-hidden bg-[var(--panel)] p-3 backdrop-blur-xl">
        <div className="relative overflow-hidden rounded-[var(--radius-inner)] border border-[var(--line)] bg-black">
          <Image
          ...
          <div className="absolute bottom-4 left-4 right-4 rounded-[var(--radius-inner)] border border-[var(--line)] bg-black/45 p-4 backdrop-blur-md">
        ...
        <div className="mt-3 hidden gap-3 lg:grid">
          {copy.profile.focus.slice(0, 3).map((item) => (
            <div
              key={item}
              className="rounded-[var(--radius-inner)] border border-[var(--line)] bg-black/20 p-4 text-sm leading-6 text-[var(--foreground)]"
            >
              {item}
            </div>
          ))}
