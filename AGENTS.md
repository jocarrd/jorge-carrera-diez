...
**Antes de trabajar, lee `../personal-brand-docs/AGENTS.md`**: ahí está el contexto
transversal del proyecto (arquitectura, convenciones, operaciones).

## Dónde está la documentación

- De este repo: `../personal-brand-docs/repos/jorge-carrera-diez/`
- Decisiones que afectan solo a este repo: `../personal-brand-docs/repos/jorge-carrera-diez/decisions.md`
- Decisiones que cruzan varios: `../personal-brand-docs/decisions/index.md`
